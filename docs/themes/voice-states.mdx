...
Each string is shorthand for its `balanced` preset. Use a typed theme object to choose `calm` or
`expressive` and override theme-specific appearance, geometry, or motion. See
